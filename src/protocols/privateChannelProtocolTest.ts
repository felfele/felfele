...
const testPrivateChannelProtocolBasicSyncing = async () => {
...
const testPrivateChannelProtocolSyncingBeforePost = async () => {
    const tester = await makePrivateChannelProtocolTester();
    const actions: PrivateSharingAction[] = [
        [tester.ALICE, tester.sharePostText('hello Bob', 1)],
        [tester.BOB, tester.sync()],
...
const testPrivateChannelProtocolBothSidesPostAndSyncSameTime = async () => {
    const tester = await makePrivateChannelProtocolTester();
    const actions: PrivateSharingAction[] = [
        [tester.ALICE, tester.sharePostText('hello Bob', 1)],
        [tester.ALICE, tester.sync()],
...
const testPrivateChannelProtocolBothSidesPostAndSync = async () => {
    const tester = await makePrivateChannelProtocolTester();
    const actions: PrivateSharingAction[] = [
        [tester.ALICE, tester.sharePostText('hello Bob', 1)],
        [tester.ALICE, tester.sync()],
...
const testPrivateChannelProtocolRemovePostBeforeSyncing = async () => {
    const tester = await makePrivateChannelProtocolTester();
...
const testPrivateChannelProtocolRemovePostAfterSyncing = async () => {
    const tester = await makePrivateChannelProtocolTester();
    const post1 = makePost('hello Alice', 1);
    const post2 = makePost('hello Bob', 2);
    const post3 = makePost('test', 3);
...
const testPrivateChannelProtocolRemoveOthersPost = async () => {
    const tester = await makePrivateChannelProtocolTester();
    const post1 = makePost('hello Alice', 1);
    const post2 = makePost('hello Bob', 2);
    const post3 = makePost('test', 3);
...
export const privateChannelProtocolTests = {
    testPrivateChannelProtocolBasicSyncing,
    testPrivateChannelProtocolSyncingBeforePost,
    testPrivateChannelProtocolBothSidesPostAndSync,
    testPrivateChannelProtocolBothSidesPostAndSyncSameTime,
    testPrivateChannelProtocolRemovePostBeforeSyncing,
    testPrivateChannelProtocolRemovePostAfterSyncing,
    testPrivateChannelProtocolRemoveOthersPost,
};
