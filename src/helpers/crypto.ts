...
export const encrypt = async (plainData: Uint8Array, secret: Uint8Array | number[], generateRandom: (lengthInBytes: number) => Promise<Uint8Array> = generateSecureRandom): Promise<Uint8Array> => {
